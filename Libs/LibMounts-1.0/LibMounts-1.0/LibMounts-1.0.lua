...
local MAJOR, MINOR = "LibMounts-1.0", tonumber("20120908235537") or 99999999999999 -- dev version should ovewrite normal version
...
function lib:GetProfessionRestriction(id)
	if lib.data["professionRestricted"][id] then
		...
		local name2, _, rank2 = GetProfessionInfo(prof1)
		if name == name1 then
			print("1")
